...
use rivet_ssh::{SshSession, TunnelHandle};
use rivet_vault::store::{UnlockedVault, VaultStore};
...
impl DaemonState {
    ...
    pub fn require_vault(&mut self) -> Result<&mut UnlockedVault, rivet_core::error::RivetError> {
        self.vault
            .as_mut()
            .ok_or(rivet_core::error::RivetError::VaultLocked)
    }
}

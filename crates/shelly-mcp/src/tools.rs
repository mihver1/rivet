...
pub fn all_tools() -> Vec<ToolDefinition> {
    vec![
        ToolDefinition {
            ...
            description: "List all SSH connections managed by Shelly. Returns connection names, hosts, ports, and group memberships. Optionally filter by group name.".into(),
            input_schema: json!({
                "type": "object",
                "properties": {
                    "group": {
